...
One option (used for example by Ethereum, see \cite{eth-horn-signature-collection}) is to form a number of subnets (via pub/sub topics), with every node joining only a few of these for diffusing votes.
