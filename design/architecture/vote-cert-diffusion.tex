...
\item
  ...
  We note that incrementally mergeable certificate schemes as described in~\cite{signature-merging} would strengthen the case for combining vote and certificate diffusion; however, exploration of such schemes is still in very early stages at this point.
\item
