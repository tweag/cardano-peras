...
\newcommand{\perasCertMaxRounds}{\ensuremath{\mi{perasCertMaxRounds}}} % also known as A / "certificate expiration"
...
\TWASetProduct{Peras}
\TWASetDate{\today}
\title{Core\TWAProductOrClient{} Design and Architecture}
